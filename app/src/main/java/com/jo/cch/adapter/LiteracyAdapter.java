 ...
 * 汉字左侧菜单
 */
public class LiteracyAdapter extends BaseExpandableListAdapter {
    private Context mcontext;
    public String[] groupString = {"一年级","二年级"};
    public String[][] childString = {
            {"上册写字表", "上册识字表", "下册写字表", "下册识字表","易错字"},{"上册写字表", "上册识字表", "下册写字表", "下册识字表","易错字"}
    };
