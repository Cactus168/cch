...
public class NotesAdapter extends BaseExpandableListAdapter {
    ...
    public String[] groupString = {"日常学习","学习日志"};
    public LearnLog[][] childString = {};

    public NotesAdapter(){}

    public NotesAdapter(LearnLog[][] childString){
...
// 获取显示指定分组的视图
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        LearnLog log = childString[groupPosition][childPosition];
        String text = log.getSubject().replace("语文/","");
        if(log.getNo() != null){
            text = text+"-"+log.getNo();
        }
        childViewHolder.tvTitle.setText(text);
        return convertView;
    }
