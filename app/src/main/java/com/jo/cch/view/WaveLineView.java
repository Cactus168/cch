...
public class WaveLineView extends RenderView {
    ...
    private Paint initLinePaint = new Paint();
    ...
    public void initLine(Canvas canvas){
        initLinePaint.setColor(lineColor);
        initLinePaint.setAntiAlias(true);
        initLinePaint.setStyle(Paint.Style.STROKE);
        initLinePaint.setStrokeWidth(thickLineWidth);
        //实线
        canvas.drawLine(0, canvas.getHeight() / 2, canvas.getWidth(), canvas.getHeight() / 2, initLinePaint);
    }
