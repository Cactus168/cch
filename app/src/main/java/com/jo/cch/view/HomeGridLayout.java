...
public class HomeGridLayout extends ViewGroup {
    ...
    public HomeGridLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.HomeGridLayout);
            colums = a.getInteger(R.styleable.HomeGridLayout_numColumns, 2);
            margin = (int) a.getInteger(R.styleable.HomeGridLayout_itemMargin, 2);
        }
    }
